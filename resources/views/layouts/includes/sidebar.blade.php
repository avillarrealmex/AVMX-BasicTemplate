<ul class="list-unstyled ps-0 components nav">
    <li class="mb-1">
        <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#gestion-collapse" aria-expanded="false">
            <i class="fa-solid fa-list-check"></i> Gestión
        </button>
        <div class="collapse" id="gestion-collapse" style="">
...
<ul class="logout list-unstyled ps-0 components">
    <li class="mb-1">
        ...
        <div class="collapse" id="account-collapse" style="">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li><a class="dropdown-item" href="{{route('logout')}}"><i class="fas fa-power-off"></i> Cerrar sesión</a></li>
            </ul>
        </div>
    </li>
</ul>
